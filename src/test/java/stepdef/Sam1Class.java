...
public class Sam1Class
{
	...
	public void user_enters_mercury_in_username_and_pasword_field() 
	{
	...
	@When("user enters {string} in username and pasword field")
	public void user_enters_in_username_and_pasword_field(String a) 
	{
